...
{
	[NumericType("КоличествоСтраницType", typeof(int))]
	[Option("Image.КоличествоСтраниц", typeof(КоличествоСтраниц))]
    public class КоличествоСтраниц : MinMaxOption
    {
        protected КоличествоСтраниц(XmlElement el)
            : base(el)
        {
